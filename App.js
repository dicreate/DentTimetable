  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={({ route }) => ({
          tabBarLabel:
            route.name === "HomeScreen" ? <TabText>Приёмы</TabText> : null,
          tabBarIcon: ({ focused }) => (
            <Ionicons
              name="clipboard-outline"
              size={22}
              color={focused ? "#2A86FF" : "#000"}
            ></Ionicons>
          ),
        })}
      />
      ...
      <Tab.Screen
        ...
        options={({ route }) => ({
          tabBarLabel:
            route.name === "Patients" ? <TabText>Пациенты</TabText> : null,
          tabBarIcon: ({ focused }) => (
            <Feather
              name="users"
              size={22}
